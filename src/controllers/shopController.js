...
export const createShop = async (req, res) => {
  try {
    ...
    console.log('Creating shop with data:', { ownerId, name, phone, address, deliveryRadius });
    
    // Validate required fields
    if (!ownerId || !name || !address) {
      return res.status(400).json({ error: 'Owner ID, shop name, and address are required' });
    }
