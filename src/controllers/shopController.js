...
export const createShop = async (req, res) => {
  try {
    ...
    const created = await createShopRecord({ ownerId, name, phone, address, deliveryRadius });
...
// Helper that can be reused by other controllers (eg. payment flow)
export const createShopRecord = async ({ ownerId, name, phone, address, deliveryRadius }) => {
  ...
  try {
    ...
    throw new Error('Unable to find location for this address. Please check the address and try again.');
  }
