...
export const addToPantry = async (req, res) => {
  try {
    const { userId, shopId, productId, productName, brandName, quantityPerPack, unit, packsOwned, price, refillThreshold } = req.body;
...
const createRefillNotification = async (pantryItem) => {
  const notification = new Notification({
    ...
    metadata: {
      ...
      address: pantryItem.userId.location?.address || 'Address not available'
    }
  });
